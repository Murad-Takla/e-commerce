...
function  GoogleIcon() {
  return (
    ...
    >
      ...
      <path
        fill="#FBBC05"
        d="M8.16 18.769A8.463 8.463 0 017.684 16c0-.964.174-1.898.46-2.769l-.008-.185-4.465-3.399-.146.069A13.785 13.785 0 002.001 16c0 2.256.556 4.387 1.524 6.285l4.635-3.516z"
      ></path>
      <path
        fill="#EB4335"
